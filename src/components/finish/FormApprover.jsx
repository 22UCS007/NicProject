...
const FormApprover = () => {
    ...
    const [newFormData, setNewFormData] = useState({
        edr: "13/06/2025",
        vatOrCot: "Normal VAT",
        allAppointmentsClosed: true,
        necessaryPaymentsReceived: true,
        ptExemption: false,
        allDocumentsUploaded: true,
        approvingAuthorityComment: "Approved"
    });
            ...
            <div className="w-full border-2 border-gray-400">
                ...
                <div className="mt-8 border border-gray-300 pt-1">
                    ...
                    <div className="flex flex-col md:flex-row items-center justify-center md:gap-6">
                        <EDRSection newFormData={newFormData} handleChange={handleChange}/>
                        
                        <VATSection newFormData={newFormData} handleChange={handleChange}/>
                    </div>

                    <YesNoQuestions newFormData={newFormData} handleChange={handleChange}/>
